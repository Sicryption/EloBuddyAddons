...
namespace UnsignedVi
{
    class MenuHandler
    {
        ...
        {
            #region CreateMenus
            mainMenu = MainMenu.AddMenu("Unsigned Vi", "Main Menu");
            ...
            AddCheckboxes(ref Combo, "Use Q", "Use E", "Use R", "Use Items", "Use Ignite", "Use Smite");
            ...
            AddCheckboxes(ref Drawing, "Draw Q", "Draw E", "Draw E Sector on Target", "Draw R", "Draw Killable Text", "Draw Enemy Health after Combo");
